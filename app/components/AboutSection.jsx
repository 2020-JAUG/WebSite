            ...
            <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
                ...
                <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
                    ...
                    <div className='flex flex-row justify-start mt-8'>
                        <TabButton selectTab={() => handleTab("skills")} active={tab === "skills"}>
                            {" "}
                            Skills{" "}
                        </TabButton>
                        <TabButton selectTab={() => handleTab('certifications')} active={tab === 'certifications'}>
                            {" "}
                            Certifications{" "}
                        </TabButton>
                        <TabButton selectTab={() => handleTab('education')} active={tab === 'education'}>
                            {" "}
                            Education{" "}
                        </TabButton>
                    </div>
